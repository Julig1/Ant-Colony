...
#define SPEED (float)(2.0F) //steplength of ant
...
#define FOOD_SCANNER_FIELD 3

//pheromones and pheromone decay
#define PHEROMONE_STEP 125 //discret steps of color. higher value is lighter color and more intense pheromone
...
#define MAX_PHEROMONE_INTENSITY 125 //after 100 steps ants will no longer spwan pheromones 
...
int main()
{
    ...
    for(int i=0; i<NUMBER_OF_ANTS; i++)
    {
        ...
        sensor_straight[i].setRadius(radius_sensor*2);
    ...
    // draw everything here...    
        ...
        for(int i=0; i<NUMBER_OF_ANTS; i++)
        {
            if (pheromone_intensity[i] >= 50)
            {
                pheromone_intensity[i] = pheromone_intensity[i] - 0.05;
            }
            //position of ant i
            ...
            if (status_ant[i] == SEEKING_FOOD)
            {
                ...
                /*ameisen_color = image.getPixel(x,y);
                int FC = ameisen_color.FOOD_COLOR;
                if(FC > 0)
                {
                    dir[i] = dir[i]+180;
                    ...
                    pheromone_intensity[i] = MAX_PHEROMONE_INTENSITY;
                    ameisen_color.FOOD_COLOR = 0;
                    image.setPixel(x,y,ameisen_color);
                    cout << "ant eat" << endl;
                }*/ 
            }
